...
TOP_LEVEL_NAME="alt_sv_gt_reset_rx"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/alt_sv_gt_reset_rx/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work alt_sv_gt_reset_rx -cdslib ./cds_libs/alt_sv_gt_reset_rx.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work alt_sv_gt_reset_rx -cdslib ./cds_libs/alt_sv_gt_reset_rx.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work alt_sv_gt_reset_rx -cdslib ./cds_libs/alt_sv_gt_reset_rx.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work alt_sv_gt_reset_rx -cdslib ./cds_libs/alt_sv_gt_reset_rx.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/alt_sv_gt_reset_rx.vhd"                                                                                                       
fi
