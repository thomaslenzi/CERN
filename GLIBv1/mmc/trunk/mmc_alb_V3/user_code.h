...
#define VOLT_3_3			4
#define VOLT_12             5
#define TEMPERATURE_SENSOR3 6
#define TEMPERATURE_SENSOR4 7
#define CURRENT_SENSOR      8
#define TEMPERATURE_SENSOR5 9	
#define TEMPERATURE_SENSOR6 10		
#define TEMPERATURE_SENSOR7 11	
#define TEMPERATURE_SENSOR8 12

//RTM sensors
#define RTM_HOT_SWAP_SENSOR 13
#define RTM_CURRENT_SENSOR  14
#define TEMPERATURE_RTM1    15
#define TEMPERATURE_RTM2    16

#define NUM_SENSOR_AMC      13   //The device locators for AMC does not count
#define NUM_SENSOR_RTM      4   //The device locators for RTM does not count

#define NUM_SDR_AMC         14
...
u08 MCP_temp_sensor_read(u08 sensor);
u08 resolve_sensor_add(u08 sensor);
void MCP_temp_init(u08 sensorID, u08 ByteToSend);
u08 PP_sensor_read();
u08 MP_sensor_read();
//********************************
