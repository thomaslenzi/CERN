...
//		* selects how much the CPU clock frequency is divided to create the A2D clock frequency
...
// default value
#define ADC_PRESCALE			ADC_PRESCALE_DIV32

// do not change the mask value
#define ADC_PRESCALE_MASK		0x07

// A2D voltage reference select
//		* this determines what is used as the full-scale voltage point for A2D conversions
...
// these channels are supported by all AVRs with A2D
...
// these channels are supported only in ATmega128
...
// This function is automatically called from a2dInit() with a default value.
void a2dSetPrescaler(u08 prescale);

// Configures which voltage reference the A/D converter uses.
// This function is automatically called from a2dInit() with a default value.
void a2dSetReference(u08 ref);
