...
COPY sfp_gtx_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\sfp_gtx_top.ucf -p xc6vcx130t-ff1156-1 sfp_gtx_top.edf sfp_gtx_top.ngd
...
ECHO 'Running NGD'
map -p xc6vcx130t-ff1156-1 -o mapped.ncd sfp_gtx_top.ngd
...
netgen -ofmt vhdl -sim -dir . -tm sfp_gtx_top -w routed.ncd routed.vhd
